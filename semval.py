...
for train_index, val_index in kf.split(X_train):
    ...
    # Plotar as métricas
    mlp.plot_metrics(accuracies, errors, val_accuracies, val_errors, fold, output_dir)

    # Previsões para matriz de confusão
    val_predictions = mlp.predict(X_val_fold)
    mlp.plot_confusion_matrix(Y_val_fold, val_predictions, fold, output_dir)
